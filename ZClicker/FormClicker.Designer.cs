namespace ZClicker
{
	partial class form_clicker
	{
		...
		private void InitializeComponent()
		{
			...
			this.button_record.Margin = new System.Windows.Forms.Padding(2, 4, 2, 4);
			this.button_record.Name = "button_record";
			this.button_record.Size = new System.Drawing.Size(260, 40);
			this.button_record.TabIndex = 0;
			this.button_record.Text = "Record";
			this.button_record.UseCompatibleTextRendering = true;
			...
			this.button_stop.Margin = new System.Windows.Forms.Padding(2, 4, 2, 4);
			this.button_stop.Name = "button_stop";
			this.button_stop.Size = new System.Drawing.Size(260, 40);
			this.button_stop.TabIndex = 1;
			this.button_stop.Text = "Stop";
			this.button_stop.UseCompatibleTextRendering = true;
			...
			this.button_run.Margin = new System.Windows.Forms.Padding(2, 4, 2, 4);
			this.button_run.Name = "button_run";
			this.button_run.Size = new System.Drawing.Size(260, 40);
			this.button_run.TabIndex = 2;
			this.button_run.Text = "Run";
			this.button_run.UseCompatibleTextRendering = true;
			...
			this.numericUD_speed.Margin = new System.Windows.Forms.Padding(2, 4, 2, 4);
			...
			this.checkbox_l2_drag_fix.Location = new System.Drawing.Point(340, 70);
			this.checkbox_l2_drag_fix.Margin = new System.Windows.Forms.Padding(2, 4, 2, 4);
			this.checkbox_l2_drag_fix.Name = "checkbox_l2_drag_fix";
			this.checkbox_l2_drag_fix.Size = new System.Drawing.Size(208, 37);
			this.checkbox_l2_drag_fix.TabIndex = 4;
			this.checkbox_l2_drag_fix.Text = "La2 drag fix";
			this.checkbox_l2_drag_fix.UseCompatibleTextRendering = true;
			...
			this.checkbox_repeat.Location = new System.Drawing.Point(339, 122);
			this.checkbox_repeat.Margin = new System.Windows.Forms.Padding(2, 4, 2, 4);
			this.checkbox_repeat.Name = "checkbox_repeat";
			this.checkbox_repeat.Size = new System.Drawing.Size(119, 37);
			this.checkbox_repeat.TabIndex = 5;
			this.checkbox_repeat.Text = "Repeat";
			this.checkbox_repeat.UseCompatibleTextRendering = true;
